...
purchase_amount = int(input('Kindly type and enter in the amount you\'ve spent today: '))
...
if purchase_amount > 500:
    ...
    finalPrice = purchase_amount - discount
    print('Original purchase amount ->', originalPrice)
    ...
    finalPrice = purchase_amount - discount
    print('Original purchase amount ->', originalPrice) ### check to see if this outputs og price
